...
Let's run the simulation and make sure it works.  This chunk can be run multiple times to manually explore the behavior of the model.

```{r two pop simulation}
ptm <- proc.time() # for timing the simulation
sim2test <- sim.2pops(a.mu.1=0.0014,a.mu.2=0.0008,larvala.mu.1=.002,adulta.mu.1=0.01,fish.1=0.2,fish.2=0)

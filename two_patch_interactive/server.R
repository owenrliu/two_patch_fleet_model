...
# source(file='two_patch_interactive/two_patch_fxns_shiny.R')
# paramNames <- c('nyears','max.age','Linf.1','K.1','t0.1','surv.1','mort.1','repr.age.1','gamma.1',
#                 'fert1.1','fert2.1','fish.1','L50.1','L95.1','lw.a.1','lw.b.1','a.mu.1','a.cv.1',
#                 'Linf.2','K.2','t0.2','surv.2','mort.2','repr.age.2','gamma.2','fert1.2','fert2.2',
#                 'fish.2','L50.2','L95.2','lw.a.2','lw.b.2','a.mu.2','a.cv.2','larvala.mu.1',
#                 'larvala.cv.1','adulta.mu.1','adulta.cv.1','larvala.mu.2','larvala.cv.2','adulta.mu.2',
#                 'adulta.cv.2')
...
shinyServer(function(input, output, session) {
  ...
  # #
  # simtest <- reactive(do.call(sim.2pops,getParams()))
  # 
